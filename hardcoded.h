...
ActionsScript registerSold() {
    ...
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 406}});
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 408}});
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 410}});
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 412}});
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 414}});
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 404}});
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 402}});
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 400}});
    sold.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{708, 409}});
...
ActionsScript registerHard() {
    ...
    hardcoded.addAction({ACTION_TYPE::WAIT_MILLISECONDS, 500});
    ...
    hardcoded.addAction({ACTION_TYPE::LEFT_MOUSE_CLICK, LOCATION{1219, 625}});
